...
public class Drive extends SubsystemBase {
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    drive(xSpeed, ySpeed, rot, fieldRelative, DriveConstants.kMaxSpeedMetersPerSecond);
  }

  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, double maxSpeed) {
    double linearMagnitude = MathUtil.applyDeadband(Math.hypot(xSpeed, ySpeed), 0.1);
    Rotation2d linearDirection = new Rotation2d(xSpeed, ySpeed);
    double rotation = MathUtil.applyDeadband(rot, 0.1);

    linearMagnitude *= linearMagnitude; // Squared input for better control
    rotation = Math.copySign(rotation * rotation, rotation);

    Translation2d linearVelocity = new Pose2d(new Translation2d(), linearDirection).transformBy(
        new Transform2d(linearMagnitude, 0, new Rotation2d())).getTranslation();
